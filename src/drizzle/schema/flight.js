const { int,datetime, mysqlTable, varchar } = require('drizzle-orm/mysql-core');
...
const flight = mysqlTable("flight", {
    ...
    departureAirportID: int('departureAirportID').references(()=>airport.airportID),
    arrivalAirportID: int('arrivalAirportID').references(()=>airport.airportID),
